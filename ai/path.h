...
public:
    Position() : x(0), y(0), r(direction::Type::UP) {};
    Position(i8 x, i8 y, direction::Type r) : x(x), y(y), r(r) {};
public:
...
public:
    ...
    static Queue cancel_movement_horizontal(u8 height[6], move::Placement placement, cell::Pair pair);
    static Queue cancel_movement_vertical(u8 height[6], move::Placement placement, cell::Pair pair);
};
