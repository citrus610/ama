...
void Finder::expand(Field& field, u8 height[6], Finder::Node& node, std::vector<Finder::Node>& queue, PositionMap& queue_map)
{
    ...
    Finder::Node cw = node;
    // if (cw.position.move_cw(field, height) && cw.position.y < 13 && cw.position.y + Direction::get_offset_y(cw.position.r) < 13) {
    ...
    // if (ccw.position.move_ccw(field, height) && ccw.position.y < 13 && ccw.position.y + Direction::get_offset_y(ccw.position.r) < 13) {
    ...
    // if (m180.position.move_180(field, height) && m180.position.y < 13 && m180.position.y + Direction::get_offset_y(m180.position.r) < 13) {
